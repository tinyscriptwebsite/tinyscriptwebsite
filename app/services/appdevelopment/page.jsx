...
import appdev from "../../assets/newfigma/services/appdev/appdev.svg";
import bar from "../../assets/newfigma/Bar.svg";
import { appCards, appMobileCards } from "../../constants/constants";
import WebServiceCard from "@/app/common/WebServiceCard";
        ...
        <section className="flex justify-between items-center md:flex-row flex-col-reverse">
          ...
          <div className="text-center md:w-[45%] w-full">
            ...
            <p className="text-lg md:mt-4 mt-2 md:text-center text-justify">
              Develop robust and intuitive mobile applications tailored for the
              Android and Ios platform, meeting the dynamic requirements of
              today's users with ease.
            </p>
          </div>
        </section>
        ...
        <section className="md:py-16 py-12">
          <div className="container mx-auto">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
              {!isMobile ? (
                <WebServiceCard services={appCards} />
              ) : (
                <WebServiceCard services={appMobileCards} isMobile={true} />
              )}
            </div>
          </div>
        </section>
