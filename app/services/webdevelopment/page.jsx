...
import webDev from "../../assets/newfigma/services/webdev/Web Devlopment Image.svg";
import { webCards, webMobileCards } from "@/app/constants/constants";
  ...
  return (
    <Pages>
      ...
      <div className="md:px-[10%] sm:px-[5%] px-[3%] md:pt-40 pt-32 ">
        {/* Hero Section */}
        <section className="flex gap-4 justify-between items-center md:flex-row flex-col-reverse">
          <div>
            <Image
              src={webDev}
        ...
        <section className="md:py-16 py-12">
          <div className="container mx-auto">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
              {!isMobile ? (
                <WebServiceCard services={webCards} />
              ) : (
                <WebServiceCard services={webMobileCards} isMobile={true} />
              )}
            </div>
          </div>
        </section>
